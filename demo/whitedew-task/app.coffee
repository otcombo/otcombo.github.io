...
btn.states.add
	hide: opacity: 0, rotationZ: 100, scale: .8
	show: opacity: 1, rotationZ: 0, scale: 1
btn.states.switchInstant("hide")
btn.states.animationOptions = curve: "spring(300, 20, 0)"
overlay.states.add
	hide: opacity: 0
	show: opacity: .93
...
bg.on Events.Click,() ->
	...
	Utils.delay .2, ->
		...
		Utils.delay 6.2, ->
			...
			btn.on Events.Click,() ->
				overlay.states.switch("hide")
				task.states.switch("hide")
				btn.states.switch("hide")